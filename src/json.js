...
,_rotate=(num=0xff,arr=0)=>{let a0=Array.isArray(arr)?[...arr]:[...d.a],a1=[0,2,1],a2,d0=0;
  ...
  const modes=[
    () => loremEpsum(randInt(1, 3)),
    () => ["⚠️ ACCESS DENIED", "💀 CORRUPTED DATA", "🛑 INTRUDER ALERT"][randInt(0, 3)],
    () => "Error 0x" + randomNumber(8).match(/.{2}/g).join(' ')
  ];return modes[randInt(0, modes.length)]();
...
};export{a,d,beta,BsTB,irritator,gDec,gEnc,plain,hex,randInt,_rotate,SnC,Matrix,IV,EinsteinHeadspin}
